...
class BuildingsTest < ApplicationSystemTestCase
  ...
  test "should create building" do
    ...
    fill_in "Other description", with: @building.other_description
    check "Register status" if @building.register_status
  ...
  test "should destroy Building" do
    visit building_url(@building)
    accept_confirm { click_on "Destroy this building", match: :first }
